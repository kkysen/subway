...
public interface FeedEntityOrBuilder extends
   ...
   * <code>optional .transit_realtime.TripUpdate trip_update = 3;</code>
   */
  sen.khyber.subway.client.proto.TripUpdate getTripUpdate();
  /**
   * <pre>
   * Data about the entity itself. Exactly one of the following fields must be
   * present (unless the entity is being deleted).
   ...
   * <code>optional .transit_realtime.TripUpdate trip_update = 3;</code>
   */
  sen.khyber.subway.client.proto.TripUpdateOrBuilder getTripUpdateOrBuilder();
   ...
   * <code>optional .transit_realtime.VehiclePosition vehicle = 4;</code>
   */
  sen.khyber.subway.client.proto.VehiclePosition getVehicle();
  /**
   * <code>optional .transit_realtime.VehiclePosition vehicle = 4;</code>
   */
  sen.khyber.subway.client.proto.VehiclePositionOrBuilder getVehicleOrBuilder();
   ...
   * <code>optional .transit_realtime.Alert alert = 5;</code>
   */
  sen.khyber.subway.client.proto.Alert getAlert();
  /**
   * <code>optional .transit_realtime.Alert alert = 5;</code>
   */
  sen.khyber.subway.client.proto.AlertOrBuilder getAlertOrBuilder();
}
